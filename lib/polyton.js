...
var PolytonFactory = exports.PolytonFactory = function PolytonFactory(Class, options) {
  ...
  return makePolyton((0, _singletons.SingletonFactory)(BasePolytonFactory(Class, options), [{
    type: 'array',
    sub: options,
    rest: true
  }]));
