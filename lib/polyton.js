  ...
  return {
    preprocess: function preprocess(args) {
      ...
      return _args.map(function (arg) {
        return [new (Function.prototype.bind.apply(ClassSingleton, [null].concat(_toConsumableArray(arg))))()];
      });
    },
...
var PolytonFactory = exports.PolytonFactory = function PolytonFactory(Class, classHintsOrKeyfunc) {
  ...
  var PolytonSingleton = (0, _singletons.SingletonFactory)(BasePolyton, getPolytonHintsOrKeyfunc(polytonOptions), getPolytonOptions(ClassSingleton, polytonOptions));
  ...
  var Polyton = function Polyton() {
    ...
    return PolytonSingleton.apply(undefined, _toConsumableArray((0, _argu.toArrayOfArrays)(args)));
  };
  ...
  Polyton.get = function () {
    return Polyton.singleton(Polyton.key.apply(Polyton, arguments));
  };
  Polyton.key = function () {
    ...
    return PolytonSingleton.key.apply(PolytonSingleton, _toConsumableArray(args.map(function (arg) {
      return [new (Function.prototype.bind.apply(ClassSingleton, [null].concat(_toConsumableArray(arg))))()];
    })));
  };
