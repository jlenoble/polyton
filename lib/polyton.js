...
var PolytonFactory = exports.PolytonFactory = function PolytonFactory(Class, classSingletonOptions, basePolytonSingletonOptions, basePolytonOptions) {
  ...
  var _preprocess = basePolytonOptions && basePolytonOptions.preprocess;
  if (!_preprocess) {
    _preprocess = function _preprocess(args) {
      return args;
    };
  }

  var BasePolyton = BasePolytonFactory(Class, classSingletonOptions, basePolytonOptions);
  var Polyton = makePolyton((0, _singletons.SingletonFactory)(BasePolyton, _basePolytonSingletonOptions, _preprocess));
